...
function Home() {
  ...
  return (
    <div className='home-container'>
      ...
      <div className="slider-container" style={{ position: 'absolute', top: 100, left: 10, zIndex: 1, padding: 10, background: '#cccc', borderRadius: 4 }}>
        <div className='slider-container-range'>
          <CiCirclePlus size={22} onClick={increaseValue} />
          <input
            type="range"
            className="slider"
          ...
          <div className='nav-icon'>
            <GrSubtractCircle size={22} onClick={decreaseValue} />
